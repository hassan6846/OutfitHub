                ...
                <MDBRow className="g-0">
                    ...
                    <div className="p-5">
                      ...
                      <div className="cart_items_contional">
                        ...
                        <div className="no_items_inCart">
                          <p className="no_cart_items_msg">There are no items in this cart</p>
                          <Link to="/shop" className="no_cart_Link">CONTINUE SHOPPING</Link>
                        </div>
                      </div>
                      <div className="pt-5">
                        <MDBTypography tag="h6" className="mb-0">
                  ...
                  <MDBCol lg="4" className="bg-grey">
                    <div className="p-5">
                      ...
                      <MDBTypography style={{fontSize:"1.1rem"}} tag="h5" className="text-uppercase mb-3">
