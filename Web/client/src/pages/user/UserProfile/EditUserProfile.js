    ...
    <div className='edit_page_Container'>
      ...
      <div style={{ columnGap: "1rem" }} className='user_detail_wrapper'>
        ...
        <div>
          ...
          <p className='user_name_ans'><MDBInput size='lg' placeholder='Full Name' /></p>
        </div>
        ...
        <div className='details_wrapper'>
          ...
          <p style={{ display: "flex", alignItems: 'center', columnGap: "0.2rem" }} className='user_name_ans'>03160490149 <span style={{ backgroundColor: "rgb(75,180,151)", color: "white", padding: "4px 8px", borderRadius: "50px" }}> <Link style={{ color: "white" }}><FiEdit2 /></Link> </span>  </p>
        </div>
        {/* 5 */}
        <div className='details_wrapper'>
          <h3 className='user_name'>Address</h3>
          <p style={{ display: "flex", alignItems: 'center', columnGap: "0.2rem" }} className='update_profile_style'>03160490149 <span style={{ backgroundColor: "rgb(75,180,151)", color: "white", padding: "4px 8px", borderRadius: "50px" }}> <Link style={{ color: "white" }}><GrFormAdd style={{ fontSize: "1rem" }} /></Link> </span>  </p>
        </div>
        {/* ENDS OF CHILDS */}
      </div>
