...
const AdminSidebar = () => {
    ...
    return (
        <aside className={divClassName}>
            ...
            {/* ORDER */}
            <div className={aside_link_flex}>
                <p className={Asideheading}>Products Manegment </p>
            ...
            <div className={aside_link_flex}>
                <p className={Asideheading}>Add  Product </p>
                <NavLink to="/admin/new" className='aside_links'> <AiOutlineAppstoreAdd className={aside_icon_state} /> <span className={Asidespan}>Add Product</span> </NavLink>
            </div>
