  ...
  return (
    <footer className='footer_main' style={{ backgroundColor: "#131039" }}>
      <div className='footer_child'>
        ...
        <p to="tel:92316049019" className='footer_link_style' >Request a Call Back!</p>
        <p to="/user/contact" className='footer_link_style' >Contact Us</p>
        <p to="/faqs" className='footer_link_style' >FAQ & Help Center</p>
      </div>
      {/* 2 */}
      <div className='footer_child'>
        <p className='footer_heading'>ABOUT DESIGN</p>
        <p className='footer_link_style' >About Us</p>
        <p className='footer_link_style' >Privacy Statement</p>
        <p className='footer_link_style' >Terms & Conditions</p>
        <p to="/faqs" className='footer_link_style' >Returns & Refunds</p>
      </div>
      {/* app Link */}
      <div className='footer_child'>
      ...
      <div className='footer_child'>
        ...
        <p to="/user/vendor" className='footer_link_style'>Sell on Design</p>
